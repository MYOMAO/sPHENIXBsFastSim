...
TFile * outFile = new TFile("outputKKee.root","RECREATE");



TTree * nt_sig = new TTree("BsJPsiPhiKKee","BsJPsiPhiKKee");
...
TTree * nt_Gen = new TTree("BsJPsiPhiKKeeGen","BsJPsiPhiKKeeGen");
...
TF1 * fElectronMomResolution = new TF1("fElectronMomResolution","0.0175 + 0.0011666667 * x",TrackPTMin,TrackPTMax);
