...
void BsPlotsAnaGen(){
	...
	TString VarName[NVar] = {"BsMassGen","dcadaughterGen","decayLength_BsGen","cosTheta_BsGen","abs(KKMassGen - 1.019461)","abs(PiKKMassGen - 1.96847)","pipPtGen","pimPtGen","pipEtaGen","pimEtaGen","pipDcaGen","pimDcaGen","BsMassGen","KKMassGen","PiKKMassGen","BvtxxGen","BvtxyGen","BvtxzGen","DvtxxGen","DvtxyGen","DvtxzGen","dcadaughter_DsGen","decayLength_DsGen","cosTheta_DsGen"};
